 ...
 */
package com.commerceootb.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CommerceootbFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CommerceootbFulfilmentProcessConstants.PARENT_PROCESS);

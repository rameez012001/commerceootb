...
/**
 * Global class for all CommerceootbCore constants. You can add global constants for your extension into this class.
 */
public final class CommerceootbCoreConstants extends GeneratedCommerceootbCoreConstants
{
	public static final String EXTENSIONNAME = "commerceootbcore";


	private CommerceootbCoreConstants()
	{
		//empty
	}

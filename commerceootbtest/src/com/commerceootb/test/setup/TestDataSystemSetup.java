 ...
 */
package com.commerceootb.test.setup;
...
import com.commerceootb.test.constants.CommerceootbTestConstants;
import com.commerceootb.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CommerceootbTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/commerceootbtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/commerceootbtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/commerceootbtest/import/cstickets.impex");
			...
			importImpexFile(context, "/commerceootbtest/import/csquotes.impex");
		}
	}
}

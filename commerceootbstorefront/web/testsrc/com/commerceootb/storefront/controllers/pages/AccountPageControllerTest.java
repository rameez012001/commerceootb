...
public class AccountPageControllerTest
{
	...
	public void shouldNotUpdateProfile() throws Exception {
		...
		final String profilePage = accountController.updateProfile((KycDocumentForm) profileForm, bindingResult, page, redirectModel);
	...
	@Test
	public void shouldNotUpdateDuplicateUidProfile() throws Exception {

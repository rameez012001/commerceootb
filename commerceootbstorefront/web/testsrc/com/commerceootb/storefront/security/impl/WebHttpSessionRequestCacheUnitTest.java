...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceootbstorefront/electronics/en",
						"https://electronics.local:9002/commerceootbstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceootbstorefront/electronics/en",
						"https://electronics.local:9002/commerceootbstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/commerceootbstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/commerceootbstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/commerceootbstorefront/electronics/en",
						"https://electronics.local:9002/commerceootbstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/commerceootbstorefront",
						"https://electronics.local:9002/commerceootbstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/commerceootbstorefront",
						"https://electronics.local:9002/commerceootbstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/commerceootbstorefront/electronics/en",
						"https://electronics.local:9002/commerceootbstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}

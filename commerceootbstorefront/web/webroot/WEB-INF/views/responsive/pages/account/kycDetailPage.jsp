    ...
    <div class="container-lg col-md-6">
        <div class="account-section-content">
            <div class="account-section-form">
                <form:form action="save" method="post" modelAttribute="kycform">
                    ...
                    <formElement:formInputBox idKey="profile.firstName" labelKey="Nationality" path="nationality" inputCSS="text" mandatory="true"/>
                    <select id="docType" name="docType">
                        <c:forEach var="docType" items="${docTypes}">
                            <option value="${fileTypes}">${docType}</option>
                        </c:forEach>
                    </select>
                    <form:label for="dob" path="dob">Date of Birth</form:label>
                    <form:input type="date" path="dob"/>
                    <form:label for="issuedDate" path="issuedDate">Issued Date</form:label>
                    <form:input type="date" path="issuedDate"/>
                    <form:label for="expiryDate" path="expiryDate">Document Expiry Date</form:label>

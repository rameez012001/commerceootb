 ...
 */
package com.commerceootb.storefront.controllers.misc;
...
import com.commerceootb.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
			...
			final HttpServletRequest request)
	{
		...
		else
		{
			...
			{
				LOG.warn("Unknown UiExperience level [" + YSanitizer.sanitize(uiExperienceLevelString) + "] available values are: "
						+ YSanitizer.sanitize(Arrays.toString(getAvailableUiExperienceLevelsCodes())));
			}
			else
			{

...
import com.commerceootb.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
			...
			final BindingResult bindingErrors)
	{
		...
		catch (final CommerceCartModificationException ex)
		{
			...
			LOG.warn("Couldn't add product of code " + YSanitizer.sanitize(code) + " to cart.", ex);
		}

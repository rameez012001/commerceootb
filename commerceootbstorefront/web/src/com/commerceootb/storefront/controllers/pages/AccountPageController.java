...
public class AccountPageController extends AbstractSearchPageController
{
    ...
    public String updateProfile(final KycDocumentForm updateProfileForm, final BindingResult bindingResult, final Model model,
        ...
        return "redirect:/my-account/update-profile";
    }
                              ...
                              final RedirectAttributes redirectModel)
    {
        ...
        catch (final ModelNotFoundException | AmbiguousIdentifierException e)
        {
            LOG.warn(String.format("ConsentTemplate with code [%s] and version [%s] was not found",
                    YSanitizer.sanitize(consentTemplateId), YSanitizer.sanitize(version.toString())), e);
            ...
            throws CMSItemNotFoundException
    {
        ...
        {
            LOG.warn(String.format("Consent with code [%s] was not found", YSanitizer.sanitize(consentCode)), e);
        ...
        {
            LOG.error(String.format("Consent with code [%s] is already withdrawn", YSanitizer.sanitize(consentCode)), e);
            GlobalMessages.addFlashMessage(redirectModel, GlobalMessages.ERROR_MESSAGES_HOLDER,
